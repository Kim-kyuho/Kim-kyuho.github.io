...
export default async function HomePage() {
  ...
  return (
    <section className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-white shadow-xl dark:bg-gray-800 transition duration-300 hover:bg-sky-200 hover:shadow-sky-200/50 dark:hover:shadow-none rounded-xl p-6 mb-8">
