    ...
    <section>
      ...
      <div className="flex overflow-x-auto px-4 md:px-12 space-x-6 snap-x snap-mandatory scrollbar-hide">
        {dummyProjects.map((project, idx) => (
          <div key={idx} className="min-w-[80%] sm:min-w-[300px] md:min-w-[340px] snap-center flex-shrink-0 transition duration-300 hover:blur-none blur-sm hover:scale-105">
            <ProjectCard {...project} />
          </div>
        ))}
      </div>
