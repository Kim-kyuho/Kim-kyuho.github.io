...
export default function About() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8"> {/* Optional container centering */}
      ...
      <div className="bg-white hover:bg-sky-200 shadow-xl transition duration-300 hover:shadow-sky-200/50 dark:bg-gray-800 dark:hover:text-sky-950 rounded-xl p-6 mb-8">
      ...
      <div className="bg-white hover:bg-pink-200 shadow-xl hover:shadow-pink-200/50 transition duration-300 dark:bg-gray-800 dark:hover:text-pink-950 rounded-xl p-3 mb-8">
      ...
      <div className ="bg-white hover:bg-emerald-200 shadow-xl hover:shadow-emerald-200/50 transition duration-300 dark:bg-gray-800 dark:hover:text-emerald-950 rounded-xl p-3">
