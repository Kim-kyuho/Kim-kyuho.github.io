    ...
    <div className="bg-green-200 dark:bg-gray-600 p-6 rounded-3xl shadow-lg shadow-green-300/50">
      ...
      <div className="space-y-1 mb-6">
        ...
        <div className="relative">
          ...
          {showCategories && (
            <div className="absolute z-10 top-1 left-full ml-0.5 bg-gradient-to-br from-pink-100 via-white to-emerald-100 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 shadow-xl rounded-xl p-3 ring-1 ring-emerald-200 animate-fade-in">
