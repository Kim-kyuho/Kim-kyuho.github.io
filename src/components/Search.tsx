        ...
        <ul className="space-y-4">
          {paginated.map((post) => (
            <li key={post.slug}>
              <Link
                href={`/blog/${post.slug}`}
                className="block bg-white dark:bg-white/5 p-4 rounded-xl border-white/70 dark:border-white/20 shadow-xs transition duration-300 ease-in-out hover:bg-indigo-500 hover:shadow-indigo-300 active:scale-95 transition-transform"
              >
                <div>
